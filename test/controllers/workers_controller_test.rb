...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { job_title: @worker.job_title, name: @worker.name } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { job_title: @worker.job_title, name: @worker.name } }
